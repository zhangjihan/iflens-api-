...
class ProductController extends AdminController
{
    ...
    protected function grid()
    {
        ...
        $grid->column('lens_id', __('Lens id'));
        $grid->column('frame_id', __('Frame id'));
    ...
    protected function detail($id)
    {
        ...
        $show->field('id', __('Id'));
        $show->field('lens_id', __('Lens id'));
        $show->field('frame_id', __('Frame id'));
    ...
    protected function form()
    {
        ...
        $form->number('lens_id', __('Lens id'));
        $form->number('frame_id', __('Frame id'));
